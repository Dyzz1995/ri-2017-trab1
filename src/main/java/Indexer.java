...
public class Indexer {
    ...
    private void stopwordsFiltering() {
        words = words.stream()                                  // convert list to stream
                .filter(word -> !stopwords.contains(word))      // filter context
    ...
    private void stemmingWords() {
       for (int i = 0; i < words.size(); i++) {
           ...
           if (word.charAt(wordLength - 1) == 's' && word.charAt(wordLength - 2) != 's') {
